    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex justify-between items-center h-20">
        ...
        >
          ...
          <g
            id="SvgjsG1101"
            transform="matrix(1.111111, 0, 0, 1.111111, 2.623159, 1.31273)"
            fill="#fff"
          >
            <path
              xmlns="http://www.w3.org/2000/svg"
              d="M 5 10.537 C 5 7.492 7.491 5 10.537 5 L 48.616 5 L 48.616 36.946 L 39.005 36.946 L 25.916 23.857 L 5 23.857 L 5 10.537 Z M 5 26.626 L 24.769 26.626 L 36.946 38.803 L 36.946 48.616 L 5 48.616 L 5 26.626 Z M 5 51.384 L 36.946 51.384 L 36.946 61.197 L 24.769 73.374 L 5 73.374 L 5 51.384 Z M 48.615 95 L 10.537 95 C 7.491 95 5 92.508 5 89.463 L 5 76.143 L 25.916 76.143 L 39.004 63.055 L 48.615 63.055 L 48.615 95 Z M 95 89.463 C 95 92.508 92.508 95 89.463 95 L 51.384 95 L 51.271 63.238 L 56.136 62.424 L 60.243 59.729 L 74.084 76.142 L 95 76.142 L 95 89.463 Z M 95 73.374 L 75.231 73.374 L 61.6 57.437 L 63.054 51.385 L 95 51.385 L 95 73.374 Z M 95 48.616 L 63.054 48.616 L 61.692 42.912 L 75.231 26.626 L 95 26.626 L 95 48.616 Z M 95 23.857 L 74.084 23.857 L 60.485 41.086 L 57.905 38.407 L 51.384 36.946 L 51.384 5 L 89.463 5 C 92.508 5 95 7.492 95 10.537 L 95 23.857 Z"
            />
          </g>
          <g
            id="SvgjsG1102"
          ...
          <text
            ...
            transform="matrix(1.4338, 0, 0, 1.208052, -45.168987, -88.214485)"
            x="61.849"
            y="130.519"
          >
            D
